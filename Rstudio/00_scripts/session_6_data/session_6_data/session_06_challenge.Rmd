...
We will be using stock prices in this analysis. You know already how to use an API to retrieve stock prices. But I obtained the stock prices for every stock in the S&P 500 index for you already. The files are saved in the `session_6_data` directory. 
...
```{r}
# STOCK PRICES
sp_500_prices_tbl <- read_rds("C:/Users/Shawn/Documents/Rstudio/00_scripts/session_6_data/session_6_data/sp_500_prices_tbl.rds")
sp_500_prices_tbl
```
...
```{r}
# SECTOR INFORMATION
sp_500_index_tbl <- read_rds("C:/Users/Shawn/Documents/Rstudio/00_scripts/session_6_data/session_6_data/sp_500_index_tbl.rds")
sp_500_index_tbl
```
...
```{r}
sp_500_daily_returns_tbl <- read_rds("C:/Users/Shawn/Documents/Rstudio/00_scripts/session_6_data/session_6_data/sp_500_daily_returns_tbl.rds")
...
We're going to import the correct results first (just in case you were not able to complete the last step).
```{r}
stock_date_matrix_tbl <- read_rds("C:/Users/Shawn/Documents/Rstudio/00_scripts/session_6_data/session_6_data/stock_date_matrix_tbl.rds")
```
...
We're going to import the correct results first (just in case you were not able to complete the last step).
```{r}
k_means_mapped_tbl <- read_rds("C:/Users/Shawn/Documents/Rstudio/00_scripts/session_6_data/session_6_data/k_means_mapped_tbl.rds")
```
...
```{r}
k_means_mapped_tbl <- read_rds("C:/Users/Shawn/Documents/Rstudio/00_scripts/session_6_data/session_6_data/k_means_mapped_tbl.rds")
umap_results_tbl   <- read_rds("C:/Users/Shawn/Documents/Rstudio/00_scripts/session_6_data/session_6_data/umap_results_tbl.rds")
```
